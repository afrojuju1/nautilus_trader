...
use super::{
    ...
    historical_marks::{fetch_candidate_bars, historical_candidate_mark},
};
...
fn replay_candidate(
    ...
    let (close_net_premium, mark_ts_utc, total_volume) =
        historical_candidate_mark(candidate, bars, lookahead_minutes, &mut warnings)
